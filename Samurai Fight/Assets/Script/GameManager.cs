...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("AnimationManager belum di-assign di Inspector GameManager!");
        }
    ...
    public void StartRound()
    {
        ...
        animationManager.MovePionVisual(player, player.position);
        animationManager.MovePionVisual(ai, ai.position);
    ...
    public void PauseGame()
    {
        ...
        if (MusicManager.Instance != null) MusicManager.Instance.PauseBGM();
    }
    ...
    public void ResumeGame()
    {
        ...
        if (MusicManager.Instance != null) MusicManager.Instance.PlayBGM(false);

        bool shouldBeInteractable = playerState != PlayerTurnState.None || currentAttackPhase == AttackPhase.PlayerSelectingTangkisCards;
    ...
    private IEnumerator HandleMoveCoroutine(Card clickedCard, SistemKartu slotController)
    {
        ...
        if (isValidMove)
        {
            ...
            yield return StartCoroutine(animationManager.MovePionStepByStep(player, newPosition));
